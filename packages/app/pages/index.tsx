...
const Home: NextPage = () => {
  ...
  const [
    { data: priceData, error: priceError, loading: priceLoading },
    readPrice,
  ] = useContractRead(
    {
      addressOrName: "0x5FbDB2315678afecb367f032d93F642f64180aa3",
  ...
  const [
    {
      data: relinquishContinentData,
      error: relinquishContinentError,
      loading: relinquishContinentLoading,
    },
  ...
  const [
    {
      data: transferContinentData,
      error: transferContinentError,
      loading: transferContinentLoading,
    },
  ...
  const [
    {
      data: acquireContinentData,
      error: acquireContinentError,
      loading: acquireContinentLoading,
    },
    acquireContractCall,
  ] = useContractWrite(
    {
    ...
    <>
      ...
      >
        ...
        <div className="float-right">
          ...
          <p>Price: {gweiFormatter(priceData?.toString())}</p>
